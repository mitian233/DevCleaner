...
A powerful command-line tool **on Windows** for cleaning cache files generated by development tools, featuring a modern TUI interactive interface.
...
- **System Temporary Files** - `%LOCALAPPDATA%\Temp` (Windows) or `/tmp` (Unix)
